...
from dataset.lm_dataset_vlm import VLMSFTDataset, vlm_collate_fn
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind VLM Full SFT")
    ...
    parser.add_argument("--save_weight", default="full_sft", type=str, help="saved weight prefix")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/sft_i2t.parquet", help="multimodal SFT dataset")
    ...
    parser.add_argument("--freeze_llm", default=0, type=int, choices=[0, 1], help="freeze the language model")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-VLM-Full-SFT", help="wandb project name")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = (
            f"MiniMind-VLM-Full-SFT-Epoch-{args.epochs}-"
